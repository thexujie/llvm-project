...
; GFX12-NEXT:    s_load_b256 s[0:7], s[10:11], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s30, s7
; GFX12-NEXT:    s_lshr_b32 s34, s7, 16
; GFX12-NEXT:    s_bfe_i64 s[28:29], s[6:7], 0x100000
; GFX12-NEXT:    s_lshr_b32 s6, s6, 16
; GFX12-NEXT:    s_bfe_i64 s[22:23], s[4:5], 0x100000
...
; GFX12-NEXT:    v_dual_mov_b32 v10, s34 :: v_dual_mov_b32 v3, s7
; GFX12-NEXT:    s_bfe_i64 s[16:17], s[2:3], 0x100000
; GFX12-NEXT:    s_lshr_b32 s2, s2, 16
; GFX12-NEXT:    s_bfe_i64 s[4:5], s[4:5], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v0, s28 :: v_dual_mov_b32 v5, s23
; GFX12-NEXT:    v_dual_mov_b32 v2, s6 :: v_dual_mov_b32 v13, s25
...
; GFX12-NEXT:    v_dual_mov_b32 v14, s26 :: v_dual_mov_b32 v7, s5
; GFX12-NEXT:    s_bfe_i64 s[10:11], s[0:1], 0x100000
; GFX12-NEXT:    s_lshr_b32 s0, s0, 16
; GFX12-NEXT:    s_bfe_i64 s[2:3], s[2:3], 0x100000
; GFX12-NEXT:    v_dual_mov_b32 v6, s4 :: v_dual_mov_b32 v17, s19
...
; GFX12-NEXT:    global_store_b128 v24, v[0:3], s[8:9] offset:96
...
; GFX12-NEXT:    s_clause 0x5
; GFX12-NEXT:    global_store_b128 v24, v[12:15], s[8:9] offset:80
