...
; RV32I-NEXT:    lw s5, 24(a1)
; RV32I-NEXT:    lw s6, 28(a1)
; RV32I-NEXT:    mv s0, a0
; RV32I-NEXT:    li a2, 1
; RV32I-NEXT:    mv a0, a3
; RV32I-NEXT:    mv a1, a4
...
; RV32IM-NEXT:    lw s1, 8(a1)
; RV32IM-NEXT:    lw s2, 12(a1)
; RV32IM-NEXT:    lw s3, 16(a1)
; RV32IM-NEXT:    lw s4, 20(a1)
; RV32IM-NEXT:    lw s5, 24(a1)
; RV32IM-NEXT:    lw s6, 28(a1)
