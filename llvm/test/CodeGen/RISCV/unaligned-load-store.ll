...
; SLOW-NEXT:    srli a2, a1, 8
; SLOW-NEXT:    sb a1, 0(a0)
; SLOW-NEXT:    srli a3, a1, 24
; SLOW-NEXT:    srli a1, a1, 16
; SLOW-NEXT:    sb a3, 3(a0)
...
; RV32I-NEXT:    sb a6, 7(a0)
; RV32I-NEXT:    sb a2, 6(a0)
; RV32I-NEXT:    sb a4, 5(a0)
; RV32I-NEXT:    sb a5, 3(a0)
; RV32I-NEXT:    sb a1, 2(a0)
; RV32I-NEXT:    sb a3, 1(a0)
; RV32I-NEXT:    ret
;
...
; RV64I-NEXT:    sb a3, 7(a0)
; RV64I-NEXT:    sb a4, 6(a0)
; RV64I-NEXT:    sb a5, 5(a0)
; RV64I-NEXT:    sb a6, 4(a0)
; RV64I-NEXT:    sb a7, 3(a0)
