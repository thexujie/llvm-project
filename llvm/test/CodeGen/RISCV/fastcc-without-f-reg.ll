...
; ZFINX32-NEXT:    sw a0, 88(sp) # 4-byte Folded Spill
; ZFINX32-NEXT:    lw a0, 4(t0)
; ZFINX32-NEXT:    sw a0, 84(sp) # 4-byte Folded Spill
; ZFINX32-NEXT:    lw a0, 8(t0)
; ZFINX32-NEXT:    sw a0, 80(sp) # 4-byte Folded Spill
; ZFINX32-NEXT:    lw a0, 12(t0)
; ZFINX32-NEXT:    sw a0, 76(sp) # 4-byte Folded Spill
; ZFINX32-NEXT:    lw a4, 16(t0)
; ZFINX32-NEXT:    lw a5, 20(t0)
; ZFINX32-NEXT:    lw a6, 24(t0)
; ZFINX32-NEXT:    lw a7, 28(t0)
; ZFINX32-NEXT:    lw t2, 32(t0)
; ZFINX32-NEXT:    lw t3, 36(t0)
; ZFINX32-NEXT:    lw t4, 40(t0)
; ZFINX32-NEXT:    lw t5, 44(t0)
; ZFINX32-NEXT:    lw t6, 48(t0)
; ZFINX32-NEXT:    lw t1, 52(t0)
...
; ZFINX32-NEXT:    lw a0, 108(t0)
; ZFINX32-NEXT:    lw a1, 112(t0)
; ZFINX32-NEXT:    lw a2, 116(t0)
; ZFINX32-NEXT:    lw a3, 120(t0)
...
; ZFINX32-NEXT:    sw a0, 56(sp)
; ZFINX32-NEXT:    sw a1, 60(sp)
; ZFINX32-NEXT:    sw a2, 64(sp)
; ZFINX32-NEXT:    sw a3, 68(sp)
; ZFINX32-NEXT:    sw t0, 72(sp)
; ZFINX32-NEXT:    lw a0, 88(sp) # 4-byte Folded Reload
; ZFINX32-NEXT:    lw a1, 84(sp) # 4-byte Folded Reload
; ZFINX32-NEXT:    lw a2, 80(sp) # 4-byte Folded Reload
; ZFINX32-NEXT:    lw a3, 76(sp) # 4-byte Folded Reload
...
; ZFINX64-NEXT:    sd a0, 160(sp) # 8-byte Folded Spill
; ZFINX64-NEXT:    ld a0, 24(t0)
; ZFINX64-NEXT:    sd a0, 152(sp) # 8-byte Folded Spill
; ZFINX64-NEXT:    ld a4, 32(t0)
; ZFINX64-NEXT:    ld a5, 40(t0)
; ZFINX64-NEXT:    ld a6, 48(t0)
; ZFINX64-NEXT:    ld a7, 56(t0)
; ZFINX64-NEXT:    ld t2, 64(t0)
; ZFINX64-NEXT:    ld t3, 72(t0)
; ZFINX64-NEXT:    ld t4, 80(t0)
; ZFINX64-NEXT:    ld t5, 88(t0)
; ZFINX64-NEXT:    ld t6, 96(t0)
; ZFINX64-NEXT:    ld t1, 104(t0)
...
; ZFINX64-NEXT:    ld a0, 216(t0)
; ZFINX64-NEXT:    ld a1, 224(t0)
; ZFINX64-NEXT:    ld a2, 232(t0)
; ZFINX64-NEXT:    ld a3, 240(t0)
...
; ZFINX64-NEXT:    sd a0, 112(sp)
; ZFINX64-NEXT:    sd a1, 120(sp)
; ZFINX64-NEXT:    sd a2, 128(sp)
; ZFINX64-NEXT:    sd a3, 136(sp)
; ZFINX64-NEXT:    sd t0, 144(sp)
; ZFINX64-NEXT:    ld a0, 176(sp) # 8-byte Folded Reload
; ZFINX64-NEXT:    ld a1, 168(sp) # 8-byte Folded Reload
; ZFINX64-NEXT:    ld a2, 160(sp) # 8-byte Folded Reload
; ZFINX64-NEXT:    ld a3, 152(sp) # 8-byte Folded Reload
...
; ZDINX32-NEXT:    sw a0, 88(sp) # 4-byte Folded Spill
; ZDINX32-NEXT:    lw a0, 4(t0)
; ZDINX32-NEXT:    sw a0, 84(sp) # 4-byte Folded Spill
; ZDINX32-NEXT:    lw a0, 8(t0)
; ZDINX32-NEXT:    sw a0, 80(sp) # 4-byte Folded Spill
; ZDINX32-NEXT:    lw a0, 12(t0)
; ZDINX32-NEXT:    sw a0, 76(sp) # 4-byte Folded Spill
; ZDINX32-NEXT:    lw a4, 16(t0)
; ZDINX32-NEXT:    lw a5, 20(t0)
; ZDINX32-NEXT:    lw a6, 24(t0)
; ZDINX32-NEXT:    lw a7, 28(t0)
; ZDINX32-NEXT:    lw t2, 32(t0)
; ZDINX32-NEXT:    lw t3, 36(t0)
; ZDINX32-NEXT:    lw t4, 40(t0)
; ZDINX32-NEXT:    lw t5, 44(t0)
; ZDINX32-NEXT:    lw t6, 48(t0)
; ZDINX32-NEXT:    lw t1, 52(t0)
...
; ZDINX32-NEXT:    lw a0, 108(t0)
; ZDINX32-NEXT:    lw a1, 112(t0)
; ZDINX32-NEXT:    lw a2, 116(t0)
; ZDINX32-NEXT:    lw a3, 120(t0)
...
; ZDINX32-NEXT:    sw a0, 56(sp)
; ZDINX32-NEXT:    sw a1, 60(sp)
; ZDINX32-NEXT:    sw a2, 64(sp)
; ZDINX32-NEXT:    sw a3, 68(sp)
; ZDINX32-NEXT:    sw t0, 72(sp)
; ZDINX32-NEXT:    lw a0, 88(sp) # 4-byte Folded Reload
; ZDINX32-NEXT:    lw a1, 84(sp) # 4-byte Folded Reload
; ZDINX32-NEXT:    lw a2, 80(sp) # 4-byte Folded Reload
; ZDINX32-NEXT:    lw a3, 76(sp) # 4-byte Folded Reload
...
; ZDINX64-NEXT:    sd a0, 160(sp) # 8-byte Folded Spill
; ZDINX64-NEXT:    ld a0, 24(t0)
; ZDINX64-NEXT:    sd a0, 152(sp) # 8-byte Folded Spill
; ZDINX64-NEXT:    ld a4, 32(t0)
; ZDINX64-NEXT:    ld a5, 40(t0)
; ZDINX64-NEXT:    ld a6, 48(t0)
; ZDINX64-NEXT:    ld a7, 56(t0)
; ZDINX64-NEXT:    ld t2, 64(t0)
; ZDINX64-NEXT:    ld t3, 72(t0)
; ZDINX64-NEXT:    ld t4, 80(t0)
; ZDINX64-NEXT:    ld t5, 88(t0)
; ZDINX64-NEXT:    ld t6, 96(t0)
; ZDINX64-NEXT:    ld t1, 104(t0)
...
; ZDINX64-NEXT:    ld a0, 216(t0)
; ZDINX64-NEXT:    ld a1, 224(t0)
; ZDINX64-NEXT:    ld a2, 232(t0)
; ZDINX64-NEXT:    ld a3, 240(t0)
...
; ZDINX64-NEXT:    sd a0, 112(sp)
; ZDINX64-NEXT:    sd a1, 120(sp)
; ZDINX64-NEXT:    sd a2, 128(sp)
; ZDINX64-NEXT:    sd a3, 136(sp)
; ZDINX64-NEXT:    sd t0, 144(sp)
; ZDINX64-NEXT:    ld a0, 176(sp) # 8-byte Folded Reload
; ZDINX64-NEXT:    ld a1, 168(sp) # 8-byte Folded Reload
; ZDINX64-NEXT:    ld a2, 160(sp) # 8-byte Folded Reload
; ZDINX64-NEXT:    ld a3, 152(sp) # 8-byte Folded Reload
