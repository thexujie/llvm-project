...
; RV64I-NEXT:    srli t0, a0, 32
; RV64I-NEXT:    srli t1, a0, 24
; RV64I-NEXT:    srli a0, a0, 16
; RV64I-NEXT:    sb a1, 8(a2)
; RV64I-NEXT:    srli t2, a1, 56
; RV64I-NEXT:    srli t3, a1, 48
; RV64I-NEXT:    srli t4, a1, 40
; RV64I-NEXT:    srli t5, a1, 32
; RV64I-NEXT:    srli t6, a1, 24
; RV64I-NEXT:    srli a1, a1, 16
; RV64I-NEXT:    sb t2, 15(a2)
; RV64I-NEXT:    sb t3, 14(a2)
; RV64I-NEXT:    sb t4, 13(a2)
; RV64I-NEXT:    sb t5, 12(a2)
; RV64I-NEXT:    sb t6, 11(a2)
...
; RV32I-NEXT:    or a4, a6, a5
; RV32I-NEXT:    or a3, a4, a3
; RV32I-NEXT:    andi a4, a0, 7
; RV32I-NEXT:    srl a0, a3, a4
...
; RV32I-NEXT:    lbu a4, 13(a3)
; RV32I-NEXT:    lbu a5, 14(a3)
; RV32I-NEXT:    lbu a6, 15(a3)
...
; RV32I-NEXT:    andi t0, a0, 7
; RV32I-NEXT:    sll a0, a7, t0
; RV32I-NEXT:    slli s1, s1, 8
; RV32I-NEXT:    or s0, s1, s0
; RV32I-NEXT:    slli s2, s2, 16
; RV32I-NEXT:    slli a3, a3, 24
; RV32I-NEXT:    or a1, a3, s2
; RV32I-NEXT:    or s0, a1, s0
; RV32I-NEXT:    srli a1, s0, 1
; RV32I-NEXT:    xori a3, t0, 31
...
; RV64I-NEXT:    srli a3, a3, 16
; RV64I-NEXT:    srli a5, a5, 56
; RV64I-NEXT:    sb t6, 22(a2)
; RV64I-NEXT:    srli t6, a4, 8
; RV64I-NEXT:    sb a4, 24(a2)
; RV64I-NEXT:    sb s3, 21(a2)
; RV64I-NEXT:    sb s4, 20(a2)
; RV64I-NEXT:    sb s5, 19(a2)
; RV64I-NEXT:    sb a3, 18(a2)
; RV64I-NEXT:    sb t5, 17(a2)
; RV64I-NEXT:    srli a3, a4, 56
; RV64I-NEXT:    srli t5, a4, 48
; RV64I-NEXT:    srli s3, a4, 40
; RV64I-NEXT:    srli s4, a4, 32
; RV64I-NEXT:    srli s5, a4, 24
; RV64I-NEXT:    srli a4, a4, 16
; RV64I-NEXT:    sb a3, 31(a2)
; RV64I-NEXT:    sb t5, 30(a2)
; RV64I-NEXT:    sb s3, 29(a2)
; RV64I-NEXT:    sb s4, 28(a2)
; RV64I-NEXT:    sb s5, 27(a2)
...
; RV64I-NEXT:    sb s1, 12(a2)
; RV64I-NEXT:    sb s2, 11(a2)
; RV64I-NEXT:    sb a1, 10(a2)
...
; RV32I-NEXT:    or t0, s3, s2
; RV32I-NEXT:    or t0, t0, s0
; RV32I-NEXT:    slli s5, s5, 8
; RV32I-NEXT:    or a7, s5, a7
; RV32I-NEXT:    lw s0, 24(sp) # 4-byte Folded Reload
; RV32I-NEXT:    andi s0, s0, 7
; RV32I-NEXT:    slli s6, s6, 16
; RV32I-NEXT:    slli s7, s7, 24
; RV32I-NEXT:    or t1, s7, s6
; RV32I-NEXT:    slli t2, a1, 1
; RV32I-NEXT:    or t1, t1, a7
; RV32I-NEXT:    not a7, s0
; RV32I-NEXT:    sll t2, t2, a7
; RV32I-NEXT:    slli s8, s8, 8
; RV32I-NEXT:    or t3, s8, s4
; RV32I-NEXT:    slli t4, a3, 1
; RV32I-NEXT:    slli s9, s9, 16
; RV32I-NEXT:    slli s10, s10, 24
; RV32I-NEXT:    or t5, s10, s9
; RV32I-NEXT:    slli t6, t0, 1
; RV32I-NEXT:    sll s1, t6, a7
; RV32I-NEXT:    or s2, t5, t3
; RV32I-NEXT:    slli t3, s2, 1
; RV32I-NEXT:    sll s3, t3, a7
; RV32I-NEXT:    xori a7, s0, 31
; RV32I-NEXT:    sll t4, t4, a7
; RV32I-NEXT:    slli a5, a5, 8
; RV32I-NEXT:    or a5, a5, s11
; RV32I-NEXT:    slli t3, a4, 1
; RV32I-NEXT:    sll t5, t3, a7
; RV32I-NEXT:    slli ra, ra, 16
; RV32I-NEXT:    slli a6, a6, 24
; RV32I-NEXT:    or a6, a6, ra
; RV32I-NEXT:    slli t3, t1, 1
; RV32I-NEXT:    sll s4, t3, a7
; RV32I-NEXT:    or s5, a6, a5
; RV32I-NEXT:    slli a5, s5, 1
; RV32I-NEXT:    sll s6, a5, a7
; RV32I-NEXT:    srl t3, a3, s0
; RV32I-NEXT:    or t2, t3, t2
; RV32I-NEXT:    srl s7, a0, s0
; RV32I-NEXT:    or t6, s7, t4
; RV32I-NEXT:    srl a6, a4, s0
; RV32I-NEXT:    or a7, a6, s1
; RV32I-NEXT:    srl t4, a1, s0
; RV32I-NEXT:    or t5, t4, t5
; RV32I-NEXT:    srl a4, t1, s0
; RV32I-NEXT:    or a5, a4, s3
; RV32I-NEXT:    srl t0, t0, s0
; RV32I-NEXT:    or t1, t0, s4
; RV32I-NEXT:    srl a1, s2, s0
; RV32I-NEXT:    or a3, a1, s6
; RV32I-NEXT:    srl a0, s5, s0
; RV32I-NEXT:    srli s0, s7, 8
; RV32I-NEXT:    sb s7, 0(a2)
; RV32I-NEXT:    srli s1, s7, 16
; RV32I-NEXT:    srli t6, t6, 24
; RV32I-NEXT:    sb s1, 2(a2)
; RV32I-NEXT:    srli s1, t3, 8
; RV32I-NEXT:    sb t3, 4(a2)
; RV32I-NEXT:    srli t3, t3, 16
; RV32I-NEXT:    srli t2, t2, 24
...
; RV32I-NEXT:    sb t4, 13(a2)
; RV32I-NEXT:    sb s0, 1(a2)
; RV32I-NEXT:    sb s1, 5(a2)
...
; RV64I-NEXT:    andi s4, s11, 7
; RV64I-NEXT:    or a5, a3, a0
; RV64I-NEXT:    sll a3, s2, s4
; RV64I-NEXT:    slli a7, a7, 8
...
; RV64I-NEXT:    xori a6, s4, 63
; RV64I-NEXT:    srl a0, a0, a6
; RV64I-NEXT:    or a0, a3, a0
; RV64I-NEXT:    or a1, a1, a4
; RV64I-NEXT:    slli a1, a1, 32
; RV64I-NEXT:    or a1, a1, a5
; RV64I-NEXT:    sll a1, a1, s4
; RV64I-NEXT:    slli t2, t2, 8
...
; RV64I-NEXT:    srli a4, a5, 1
; RV64I-NEXT:    srl a4, a4, a6
; RV64I-NEXT:    or a4, a1, a4
; RV64I-NEXT:    sll a6, a5, s4
; RV64I-NEXT:    srli a5, s2, 1
; RV64I-NEXT:    not a7, s4
; RV64I-NEXT:    srl a5, a5, a7
; RV64I-NEXT:    or a5, a6, a5
; RV64I-NEXT:    sll a7, s3, s4
; RV64I-NEXT:    srli t0, a7, 8
; RV64I-NEXT:    sb a7, 0(a2)
; RV64I-NEXT:    srli t1, a6, 56
; RV64I-NEXT:    srli t2, a6, 48
; RV64I-NEXT:    srli t3, a6, 40
; RV64I-NEXT:    srli t4, a6, 32
...
; RV64I-NEXT:    sb a7, 2(a2)
; RV64I-NEXT:    sb t0, 1(a2)
; RV64I-NEXT:    srli a7, a3, 56
; RV64I-NEXT:    srli t0, a3, 48
...
; RV64I-NEXT:    sb t1, 23(a2)
; RV64I-NEXT:    sb t2, 22(a2)
; RV64I-NEXT:    sb t3, 21(a2)
; RV64I-NEXT:    srli t1, a1, 56
; RV64I-NEXT:    sb t4, 20(a2)
; RV64I-NEXT:    srli t2, a1, 48
; RV64I-NEXT:    sb t5, 19(a2)
; RV64I-NEXT:    srli t3, a1, 40
...
; RV64I-NEXT:    sb t2, 30(a2)
; RV64I-NEXT:    sb t3, 29(a2)
...
; RV64I-NEXT:    sb t6, 13(a2)
; RV64I-NEXT:    sb s0, 12(a2)
; RV64I-NEXT:    sb s1, 11(a2)
; RV64I-NEXT:    sb s2, 10(a2)
; RV64I-NEXT:    sb a3, 9(a2)
; RV64I-NEXT:    sb a0, 8(a2)
; RV64I-NEXT:    ld ra, 216(sp) # 8-byte Folded Reload
; RV64I-NEXT:    ld s0, 208(sp) # 8-byte Folded Reload
...
; RV32I-NEXT:    or a1, s8, a1
; RV32I-NEXT:    or s8, a1, a4
; RV32I-NEXT:    slli s1, s1, 8
; RV32I-NEXT:    or a5, s1, a5
; RV32I-NEXT:    slli t4, t4, 16
; RV32I-NEXT:    slli t6, t6, 24
; RV32I-NEXT:    or a1, t6, t4
; RV32I-NEXT:    or a6, a1, a5
; RV32I-NEXT:    slli t0, t0, 8
...
; RV32I-NEXT:    sb a4, 20(a2)
; RV32I-NEXT:    sb s5, 10(a2)
; RV32I-NEXT:    sb t4, 9(a2)
; RV32I-NEXT:    sb a3, 8(a2)
; RV32I-NEXT:    sb s7, 14(a2)
; RV32I-NEXT:    sb a7, 13(a2)
; RV32I-NEXT:    sb a1, 12(a2)
; RV32I-NEXT:    sb s6, 6(a2)
...
; RV32I-NEXT:    or t1, s6, s4
; RV32I-NEXT:    lw s0, 24(sp) # 4-byte Folded Reload
; RV32I-NEXT:    andi s0, s0, 7
; RV32I-NEXT:    slli s7, s7, 16
; RV32I-NEXT:    slli s8, s8, 24
; RV32I-NEXT:    or t2, s8, s7
; RV32I-NEXT:    slli t3, a1, 1
; RV32I-NEXT:    or t1, t2, t1
; RV32I-NEXT:    not t2, s0
; RV32I-NEXT:    sll t4, t3, t2
; RV32I-NEXT:    slli s9, s9, 8
; RV32I-NEXT:    or t3, s9, s5
; RV32I-NEXT:    slli t5, a3, 1
; RV32I-NEXT:    slli s10, s10, 16
; RV32I-NEXT:    slli s11, s11, 24
; RV32I-NEXT:    or t6, s11, s10
; RV32I-NEXT:    slli s1, t0, 1
; RV32I-NEXT:    sll s1, s1, t2
; RV32I-NEXT:    or s2, t6, t3
; RV32I-NEXT:    slli t3, s2, 1
; RV32I-NEXT:    sll s3, t3, t2
; RV32I-NEXT:    xori t2, s0, 31
; RV32I-NEXT:    sll t5, t5, t2
; RV32I-NEXT:    slli a5, a5, 8
; RV32I-NEXT:    or a5, a5, ra
; RV32I-NEXT:    slli t3, a4, 1
; RV32I-NEXT:    sll s4, t3, t2
; RV32I-NEXT:    slli a7, a7, 16
; RV32I-NEXT:    slli a6, a6, 24
; RV32I-NEXT:    or a6, a6, a7
; RV32I-NEXT:    slli a7, t1, 1
; RV32I-NEXT:    sll s5, a7, t2
; RV32I-NEXT:    or s6, a6, a5
; RV32I-NEXT:    slli a5, s6, 1
; RV32I-NEXT:    sll s7, a5, t2
; RV32I-NEXT:    srl t3, a3, s0
; RV32I-NEXT:    or t2, t3, t4
; RV32I-NEXT:    srl s8, a0, s0
; RV32I-NEXT:    or t6, s8, t5
; RV32I-NEXT:    srl a6, a4, s0
; RV32I-NEXT:    or a7, a6, s1
; RV32I-NEXT:    srl t4, a1, s0
; RV32I-NEXT:    or t5, t4, s4
; RV32I-NEXT:    srl a4, t1, s0
; RV32I-NEXT:    or a5, a4, s3
; RV32I-NEXT:    srl t0, t0, s0
; RV32I-NEXT:    or t1, t0, s5
; RV32I-NEXT:    srl a1, s2, s0
; RV32I-NEXT:    or a3, a1, s7
; RV32I-NEXT:    sra a0, s6, s0
; RV32I-NEXT:    srli s0, s8, 8
; RV32I-NEXT:    sb s8, 0(a2)
